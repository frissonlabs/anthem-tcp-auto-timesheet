...
try:
	print("Logging in...")
	handle_login_page(driver, getenv("ANTHEM_TCP_URL"), getenv("ANTHEM_TCP_USERNAME"), getenv("ANTHEM_TCP_PASSWORD"))
	...
	fill_timesheet(driver, getenv("ANTHEM_TCP_PROJECT_ID"))
